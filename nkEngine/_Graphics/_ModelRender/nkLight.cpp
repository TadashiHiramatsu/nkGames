...
namespace nkEngine
{
	CLight::CLight()
	{
		...
		//ディフューズライト色
		m_diffuseLightColor[0] = D3DXVECTOR4(0.8f, 0.8f, 0.8f, 1.0f);
		m_diffuseLightColor[1] = D3DXVECTOR4(0.8f, 0.8f, 0.8f, 1.0f);
		m_diffuseLightColor[2] = D3DXVECTOR4(0.8f, 0.8f, 0.8f, 1.0f);
		m_diffuseLightColor[3] = D3DXVECTOR4(0.8f, 0.8f, 0.8f, 1.0f);
		m_diffuseLightColor[4] = D3DXVECTOR4(0.8f, 0.8f, 0.8f, 1.0f);
		m_diffuseLightColor[5] = D3DXVECTOR4(0.8f, 0.8f, 0.8f, 1.0f);
